...
def _copy_temp_video(temp_video_path, output_path):
...
def encode_vscode_compatible_mp4(input_video_path, output_path, audio_source_path=None):
    ...
    if ffmpeg is None:
        print("ffmpeg not found; keeping OpenCV-generated MP4 without H.264 re-encode.")
        return _copy_temp_video(input_video_path, output_path)
